...
class NVBandwidth:
    ...
    def build(self):
        ...
        results = subprocess.run('apt update', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        results = subprocess.run(['./debian_install.sh'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
